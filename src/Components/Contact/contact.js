...
import { Col, Container, InputGroup, FormControl, Row, Form } from 'react-bootstrap'
...
const Contact = () => {
  ...
  return (
    <div id='contact' className='contact-con'>
      <Container>
        <Row>
          <Col className='col-12 col-lg-8 text-start'>
          ...
          <Col className='col-12  col-lg-4 contact-form'>
            <form ref={form} onSubmit={sendEmail}>
              <InputGroup className="mb-3">
                <InputGroup.Text id="basic-addon1"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
              ...
              <InputGroup className="mb-3">
                <InputGroup.Text id="basic-addon1"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="16" viewBox="0 0 20 16" fill="none">
              ...
              <InputGroup className="mb-3">
                <InputGroup.Text id="basic-addon1"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
              ...
              <InputGroup className="mb-3">
                <InputGroup.Text id="basic-addon1"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="20" viewBox="0 0 16 20" fill="none">
              ...
              <InputGroup className='text-area-group'>
                ...
                <Form.Control as="textarea" name="message" placeholder='Write Your response here ........' />
              </InputGroup>
        ...
        <div className='d-flex align-items-center justify-content-between flex-column flex-lg-row my-5 pt-5 contact-bottom' >
          <h4 className='mb-0'>InBots - Innovating at the Intersection of Technology and Intelligence.</h4>
          <Form className='mail-form mt-4 mt-lg-0'>

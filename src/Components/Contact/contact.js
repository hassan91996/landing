      ...
      <Container>
        <Row>
          <Col className='col-12 col-lg-8 text-start wow animate__fadeInLeft' data-wow-delay=".4s">
            ...
            <h3 className='mb-5'>Ready to explore the potential of AI in your next project? Connect with us at [contact information]. Let's create something extraordinary together</h3>
            <h5 className='mb-4'>Have questions or want to join our journey?</h5>
            <p className='my-4'>
          ...
          <Col className='col-12  col-lg-4 contact-form wow animate__fadeInRight' data-wow-delay=".4s">
            <form ref={form} onSubmit={sendEmail}>
              ...
              <InputGroup className="mb-3">
                ...
                <Form.Control required
                  type="text" name="phone" placeholder="Mobile" />
              </InputGroup>
              <InputGroup className="mb-3">
                ...
                <Form.Control required name="address" placeholder=" Address"
                />
              </InputGroup>
              <InputGroup className='text-area-group'>
                ...
                <Form.Control required as="textarea" name="message" placeholder='Write Your response here ........' />
              </InputGroup>
        ...
        <div className='d-flex align-items-center justify-content-between flex-column flex-lg-row my-5 pt-5 contact-bottom' >
          <h4 className='mb-0 wow animate__fadeInLeft' data-wow-delay=".4s">InBots - Innovating at the Intersection of Technology and Intelligence.</h4>
